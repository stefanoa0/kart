...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { categoria_produto_id: @produto.categoria_produto_id, descricao: @produto.descricao, nome: @produto.nome, preco: @produto.preco }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { categoria_produto_id: @produto.categoria_produto_id, descricao: @produto.descricao, nome: @produto.nome, preco: @produto.preco }
    assert_redirected_to produto_path(assigns(:produto))
  end
