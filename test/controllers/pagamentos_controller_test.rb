...
class PagamentosControllerTest < ActionController::TestCase
  ...
  test "should create pagamento" do
    assert_difference('Pagamento.count') do
      post :create, pagamento: { num_parcelas: @pagamento.num_parcelas, tipo_pagamento_id: @pagamento.tipo_pagamento_id }
    end
  ...
  test "should update pagamento" do
    patch :update, id: @pagamento, pagamento: { num_parcelas: @pagamento.num_parcelas, tipo_pagamento_id: @pagamento.tipo_pagamento_id }
    assert_redirected_to pagamento_path(assigns(:pagamento))
  end
